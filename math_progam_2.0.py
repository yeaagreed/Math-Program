...
def grade_summary(grade):
    ...
    print("Your student is working comfortably" +
...
def weakness(operation):
    ...
    print("Your students are struggling with {}.".format(operation))
...
def question_print():
    ...
    for question in question_info:
        print("Grade: {}".format(question_info[question][5]) +
              ...
              "Correct answer: {}".format(question_info[question][3]))
